...
class Test_JobSelector:
	...
	>>> jobdb = JobDB(config)
	>>> jobdb.set_job_limit(-1)
	>>> try_catch(lambda: jobdb.get_job(0), 'AbstractError', 'is an abstract function')
	caught
	>>> try_catch(lambda: jobdb.get_job_transient(0), 'AbstractError', 'is an abstract function')
	caught
	>>> try_catch(lambda: jobdb.get_job_persistent(0), 'AbstractError', 'is an abstract function')
	caught
