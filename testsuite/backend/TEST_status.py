...
class Test_ARC:
	"""
	>>> test_check('ARC_CheckJobs', wms_id_list = ['gsiftp://grid-arc0.desy.de:2811/jobs/U3pLDmfrXYonXlDnJp9YSwCoABFKDmABFKDmWpJKDmABFKDmoDon2m'])
	STATUS=OK
...
class Test_Condor:
	"""
	>>> test_check('Condor_CheckJobs', wms_id_list = ['78905.0'])
	STATUS=OK
...
class Test_CREAM:
	"""
	>>> test_check('CREAM_CheckJobs', wms_id_list = ['https://grid-cr0.desy.de:8443/CREAM052718106'])
	STATUS=OK
...
class Test_GliteWMS:
	"""
	>>> test_check('Grid_CheckJobs', wms_id_list = ['https://lb-3-fzk.gridka.de:9000/GgeNd6MD5REG2KsbN5dmEg'], check_exec = 'glite-wms-job-status')
	STATUS=OK
...
class Test_Host:
	"""
	>>> test_check('Host_CheckJobs', wms_id_list = ['1036587'])
	STATUS=OK
...
class Test_JMS:
	"""
	>>> test_check('JMS_CheckJobs', wms_id_list = ['1036587'])
	STATUS=OK
...
class Test_LSF:
	"""
	>>> test_check('LSF_CheckJobs', wms_id_list = ['1036587'])
	STATUS=OK
...
class Test_PBS:
	"""
	>>> test_check('PBS_CheckJobs', wms_id_list = ['1036587'])
	STATUS=OK
