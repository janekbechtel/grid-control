...
class Test_GliteWMS:
	...
	>>> test_cancel('Grid_CancelJobs', wms_id_list = ['https://lb-3-fzk.gridka.de:9000/i_dont_exist'], cancel_exec = 'glite-wms-job-cancel')

	>>> test_cancel('Grid_CancelJobs', 'test.GliteWMS.cancel1', wms_id_list = ['https://lb-3-fzk.gridka.de:9000/i_dont_exist'], cancel_exec = 'glite-wms-job-cancel')
	https://lb-3-fzk.gridka.de:9000/GgeNd6MD5REG2KsbN5dmEg

	>>> test_cancel('Grid_CancelJobs', 'test.GliteWMS.cancel2', wms_id_list = ['https://lb-3-fzk.gridka.de:9000/i_dont_exist'], cancel_exec = 'glite-wms-job-cancel')
	https://lb-1-fzk.gridka.de:9000/yrCkbMwQjvEyFj3561Yung
	https://lb-1-fzk.gridka.de:9000/g6Sii-xhtPruRVRm5lyJBg

	>>> test_cancel('Grid_CancelJobs', 'test.GliteWMS.cancel3', wms_id_list = ['https://lb-3-fzk.gridka.de:9000/i_dont_exist'], cancel_exec = 'glite-wms-job-cancel')
...
class Test_LSF:
	"""
	>>> test_cancel('LSF_CancelJobs', 'test.LSF.cancel', wms_id_list = [])

	>>> test_cancel('LSF_CancelJobs', 'test.LSF.cancel', wms_id_list = ['827766504', '827766508', '827766509'])
	827766504
	827766508
	827766509
	"""
