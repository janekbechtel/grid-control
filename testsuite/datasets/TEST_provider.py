...
class Test_DataProviderBind:
	...
	<instance factory for grid_control.datasets.provider_basic.ListProvider(<SimpleConfigInterface(view = <SimpleConfigView(sections = None)>)>, 'dataset', 'file.dbs', '', dataset_proc=NullDataProcessor(), ...)>
	<instance factory for grid_control.datasets.provider_basic.ListProvider(<SimpleConfigInterface(view = <SimpleConfigView(sections = None)>)>, 'dataset', 'file.dbs', 'nick', dataset_proc=NullDataProcessor(), ...)>
	<instance factory for grid_control.datasets.provider_basic.FileProvider(<SimpleConfigInterface(view = <SimpleConfigView(sections = None)>)>, 'dataset', 'file.dbs', 'nick', dataset_proc=NullDataProcessor(), ...)>

	>>> test_bind(DP.bind('file.dbs \\n nick : file.dbs \\n nick: file : file.dbs', config = create_config(), provider_name_default ='FileProvider'))
	<instance factory for grid_control.datasets.provider_basic.FileProvider(<SimpleConfigInterface(view = <SimpleConfigView(sections = None)>)>, 'dataset', 'file.dbs', '', dataset_proc=NullDataProcessor(), ...)>
	<instance factory for grid_control.datasets.provider_basic.FileProvider(<SimpleConfigInterface(view = <SimpleConfigView(sections = None)>)>, 'dataset', 'file.dbs', 'nick', dataset_proc=NullDataProcessor(), ...)>
	<instance factory for grid_control.datasets.provider_basic.FileProvider(<SimpleConfigInterface(view = <SimpleConfigView(sections = None)>)>, 'dataset', 'file.dbs', 'nick', dataset_proc=NullDataProcessor(), ...)>
